...
#apDiv8 {
	...
	background-image: url(../images/C__Data_Users_DefApps_AppData_INTERNETEXPLORER_Temp_Saved%20Images_android.png);
}
...
<div id="apDiv1">
<div id="apDiv2">
<h3 align="center" class="style1">APP DEVOLEPMENT</h3>
</div>
<div id="apDiv3">
...
<p align="center"> Dept. of Computer Science and Information Technology//FEB 16 10AM<br>
  Android applications are trending worldwide now. got some skills in developing one of those? then add your name in the Agnitus 2k16 winners list by winning this team event.</p>
<p align="center"> Rules<br>
  -	Group event with 3 students<br>
  -	Android SDK with Android studio will be provided (java).<br>
  -	Entire event will have a duration of 3hr</p>
<p align="center">&nbsp;</p>
</div>
<div id="apDiv5"></div>
